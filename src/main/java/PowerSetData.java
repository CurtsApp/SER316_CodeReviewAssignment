...
public class PowerSetData {
	...
	public void initializeArray(String string)
			throws NumberFormatException, NoSuchElementException, NegativeArraySizeException {
	 ...
	 * 
	 * @param choice: chosen powerset algorithm, needs to be a number between 0 and
	 *        2. If the number is out of range, 2 should be chosen The attribute
	 *        algo should always contain the choosen algorithm as string
